...
local files = {
  {"!https://raw.githubusercontent.com/sziberov/OpenComputers/master/lib/json.lua", "/lib/json.lua"},
  {"!https://raw.githubusercontent.com/Def-Try/MinecGPT/master/chatgpt.lua", "/bin/chatgpt.lua"}
}
...
local PROGRAM_NAME = "MineCGPT" -- Name of your program
local PROGRAM_DESCRIPTION = "Access ChatGPT via minecraft chat!"
local INSTALLER_NAME = "IPInstaller - Internet Program Installer" -- name of your installer program
local INSTALLER_DESCRIPTION = "This program will install the MineCGPT" -- description of your installer program
